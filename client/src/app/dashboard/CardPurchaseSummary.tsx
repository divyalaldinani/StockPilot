    ...
    return (
        <div className='flex flex-col justify-between shadow-md rounded-2xl row-span-2 xl:row-span-3 col-span-1 md:col-span-2 xl:col-span-1 bg-white'>
            ...
            <>
                ...
                <div className='mb-4 mt-1 px-7'>
                    ...
                    {lastDataPoint && (
                        <p className={`text-sm ${lastDataPoint.changePercentage ! >= 0 ? "text-green-500" : "text-red-500"} flex ml-3`}>
                            {lastDataPoint.changePercentage ! >= 0 ? <TrendingUp className='w-5 h-5 mr-1'/> : <TrendingDown  className='w-5 h-5 mr-1'/>}
                ...
                {/*charts */ }
                <ResponsiveContainer width="100%" height={190} className="pt-0 pr-2 pl-2 pb-2">
                    <AreaChart
                    data={purchaseData}
