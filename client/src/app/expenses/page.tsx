...
const Expenses = () => {
  ...
  const classNames = {
    label: "block text-sm font-medium text-gray-700 border-0 border-gray-700 p-2 rounded",
    selectInput:
      "mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 border-2 border-gray-700 p-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md",
  };
